...
def send_images_example(v1, v2):
    ...
    # vid1= os.listdir(r'C:\Users\Andy\Desktop\downloadthisplz-main\images\vid1')
    # vid2 = os.listdir(r'C:\Users\Andy\Desktop\downloadthisplz-main\images\vid2')
    # vid3 = os.listdir(r'C:\Users\rayya\OneDrive\Desktop\finafina\images\highlighted_differences')



    # Get list of all files in a given directory sorted by name
    dir1_name = r'C:\Users\Andy\Desktop\downloadthisplz-main\images\vid1\*.jpg'
    list_of_files1 = filter(os.path.isfile, glob.glob(dir1_name + '*'))
    list_of_files1 = sorted(list_of_files1, key = os.path.getmtime)
    
    dir2_name = r'C:\Users\Andy\Desktop\downloadthisplz-main\images\vid2\*.jpg'
    # Get list of all files in a given directory sorted by name
    ...
    for (file_path1, file_path2) in zip(list_of_files1, list_of_files2): # show vid1 vid2 
        ...
        counter2+=1
        counter3+=1
        public_urls.append((public_url1,public_url2)) #appends URLs to a list, then returned in line 102, since it is a public URL, flutter (frontend)uses these images to portray on the app
    ...
    # #deletes all the files in vid2 so there are no conflicts for next run
    folder = 'images/vid2'
    for filename in os.listdir(folder):
        file_path = os.path.join(folder, filename)
        try:
