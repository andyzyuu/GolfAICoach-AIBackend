...
def kmeans(link1, link2): # cv2 ("reads" videos through computers) and mediapipe (angles), angles formed in each frame, compared to the coach and student
    ...
    for label in (student_cluster):
        ...
        os.chdir(r'C:\Users\Andy\Desktop\downloadthisplz-main\coach')
        for file in os.listdir(r'C:\Users\Andy\Desktop\downloadthisplz-main\coach'):
            ...
            for cluster_index in cluster_nums:              #0
                if(file == img_path and cluster_index == predict):
                    ...
                    shutil.copy2(file,r'C:\Users\Andy\Desktop\downloadthisplz-main\images\vid1')
                    cluster_nums.remove(cluster_index)
        img1 = Image.open(f'coach{nearest}.jpg')

        os.chdir(r'C:\Users\Andy\Desktop\downloadthisplz-main\student')
        for file in os.listdir(r'C:\Users\Andy\Desktop\downloadthisplz-main\student'):
            img_path = f'student{index_student}.jpg'
            if(file == img_path and isInClusterNums):
                shutil.copy2(file,r'C:\Users\Andy\Desktop\downloadthisplz-main\images\vid2')
        ...
        os.chdir(r'C:\Users\Andy\Desktop\downloadthisplz-main')
